...
function rs_get_recent_tweets($username, $consumer_key, $consumer_secret, $access_token, $access_token_secret, $cache_time = 3600) {
  ...
  {
    require_once RS_ROOT .'/extras/class/tmhOAuth.php';
    require_once RS_ROOT .'/extras/class/tmhUtilities.php';
...
function rs_time_elapsed_string($datetime, $full = false) {
    ...
    $string = array(
      'y' => esc_html__('yrs','animo-addons'),
      'm' => esc_html__('m','animo-addons'),
      'w' => esc_html__('w','animo-addons'),
      'd' => esc_html__('d','animo-addons'),
      'h' => esc_html__('hrs','animo-addons'),
      'i' => esc_html__('min','animo-addons'),
      's' => esc_html__('sec','animo-addons'),
    );
  ...
  return $string ? implode(', ', $string) . ' ' : esc_html__('just now', 'animo-addons');
}
