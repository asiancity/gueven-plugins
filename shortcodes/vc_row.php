...
function rs_row( $atts, $content = '', $key = '' ) {
  ...
  $is_fluid      = ( $fluid == 'stretch_row_only' || $fluid == 'stretch_row_content' || $fluid == 'full_stretch_row_content') ? ' fullwidth':'';
  ...
  $output  =  '<section '.$id.' class="vc_section section '.$fluid.$is_fluid.$class.$padding_top.$padding_bottom.$margin_top.$margin_bottom.$attributes.''.$css_class.'"'.$bg_attr_style.'>';
